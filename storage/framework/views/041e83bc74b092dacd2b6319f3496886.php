...
<div class="dashboard-wrapper">
    ...
    <div class="hero-banner">
        ...
        <!-- Left Content -->
        <div class="hero-left">
            <div class="hero-date"><?php echo e(date('F j, Y')); ?></div>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            <div class="stat-left">
                ...
                <div class="stat-number"><?php echo e($totalTeachers); ?></div>
        ...
        <div class="stat-card">
            <div class="stat-left">
                ...
                <div class="stat-number"><?php echo e($totalParents); ?></div>
    ...
    <div class="quick-section">
        ...
        <div class="quick-grid">
            ...
            <a href="<?php echo e(route('admin.teachers.index')); ?>" class="quick-card card-terracotta">
            ...
            <a href="<?php echo e(route('admin.parents.index')); ?>" class="quick-card card-mustard">
                <div class="qc-content">
                    <span class="qc-icon">👨‍👩‍👧</span>
            ...
            <a href="<?php echo e(route('admin.students.index')); ?>" class="quick-card card-deepblue">
                <div class="qc-content">
                    <span class="qc-icon">👩‍🎓</span>
            ...
            <a href="<?php echo e(route('admin.reports.index')); ?>" class="quick-card card-purple">
                <div class="qc-content">
                    <span class="qc-icon">📄</span>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\fatin\iep-system\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>