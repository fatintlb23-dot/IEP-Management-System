...
<head>
    ...
    <title>Teacher Dashboard - IEP System</title>
    ...
    <style>
        * {
        ...
        .sidebar .nav-section a .nav-icon.students { color: #F59E0B; }
        .sidebar .nav-section a .nav-icon.goals { color: #22C55E; }
        .sidebar .nav-section a .nav-icon.progress { color: #06B6D4; }
        .sidebar .nav-section a .nav-icon.reports { color: #8B5CF6; }
        .sidebar .nav-section a .nav-icon.settings { color: #8B5CF6; }
        .sidebar .nav-section a .nav-icon.logout { color: #EF4444; }

        .sidebar .nav-section a.active .nav-icon.dashboard { color: white; }
        .sidebar .nav-section a.active .nav-icon.students { color: white; }
        .sidebar .nav-section a.active .nav-icon.goals { color: white; }
        .sidebar .nav-section a.active .nav-icon.progress { color: white; }
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="nav-section">
            ...
            <a href="<?php echo e(route('teacher.students.index')); ?>" class="<?php echo e(request()->routeIs('teacher.students.*') ? 'active' : ''); ?>">
                <span class="nav-icon students">👩‍🎓</span>
                <span class="nav-text">My Students</span>
            </a>

            <a href="<?php echo e(route('teacher.goals.index')); ?>" class="<?php echo e(request()->routeIs('teacher.goals.*') ? 'active' : ''); ?>">
                <span class="nav-icon goals">🎯</span>
                <span class="nav-text">IEP Goals</span>
            </a>

            <a href="<?php echo e(route('teacher.progress.index')); ?>" class="<?php echo e(request()->routeIs('teacher.progress.*') ? 'active' : ''); ?>">
                <span class="nav-icon progress">📈</span>
                <span class="nav-text">Update Progress</span>
            </a>

            <a href="<?php echo e(route('teacher.reports.index')); ?>" class="<?php echo e(request()->routeIs('teacher.reports.*') ? 'active' : ''); ?>">
                <span class="nav-icon reports">📄</span>
                <span class="nav-text">Generate Reports</span>
            </a>

            <a href="<?php echo e(route('teacher.profile.index')); ?>" class="<?php echo e(request()->routeIs('teacher.profile.*') ? 'active' : ''); ?>">
                <span class="nav-icon settings">⚙️</span>
        ...
        <div class="top-header">
            <div class="user-menu" id="userMenu">
                <div class="user-trigger" onclick="toggleDropdown()">
                    <div class="user-avatar"><?php echo e(substr($teacher->name, 0, 1)); ?></div>
                    <span class="user-name"><?php echo e(ucfirst(explode(' ', $teacher->name)[0])); ?></span>
                    <span class="user-chevron" id="chevron">▼</span>
                </div>

                <div class="dropdown" id="dropdown">
                    <div class="dropdown-user-info">
                        <div class="du-avatar"><?php echo e(substr($teacher->name, 0, 1)); ?></div>
                        <div>
                            <div class="du-name"><?php echo e(ucfirst(explode(' ', $teacher->name)[0])); ?></div>
                            <div class="du-role">Teacher</div>
                        </div>
                    </div>

                    <a href="<?php echo e(route('teacher.profile.index')); ?>" class="dropdown-item">
...
</html><?php /**PATH C:\Users\fatin\iep-system\resources\views/layouts/teacher.blade.php ENDPATH**/ ?>