...
<div class="page-wrapper">
    ...
    <div class="hero-banner">
        ...
        <div class="hero-left">
            ...
            <div class="hero-subtitle">Create comprehensive progress reports for students.</div>
        </div>
            ...
            <form id="reportForm" method="POST" action="{{ route('admin.reports.generate') }}">
                ...
                <div class="steps-indicator">
                    <div class="step-item active" id="step1Indicator">
                        ...
                        <span class="step-label">Select Teacher</span>
                    </div>
                ...
                <div class="step-content active" id="step1">
                    <div class="step-title">1. Select Teacher</div>
                    <div class="step-desc">Choose a teacher to generate a report for their students.</div>
                        ...
                        <select name="teacher_id" id="teacherSelect" required>
                            ...
                            @foreach($teachers as $teacher)
                                <option value="{{ $teacher->id }}">
                                    {{ $teacher->name }} 
                                    ({{ App\Models\Student::where('teacher_id', $teacher->id)->count() }} students)
                                </option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="step-content" id="step2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="report-type-grid">
                            <label class="report-type-option selected" onclick="selectReportType('Weekly')">
                                <input type="radio" name="report_type" value="Weekly" checked>
    ...
    function goToStep(step) {
        ...
        if (step === 2 && currentStep === 1) {
            ...
            if (!teacherSelect.value) {
                alert('Please select a teacher or "All Teachers".');
                return;
            }
        }
